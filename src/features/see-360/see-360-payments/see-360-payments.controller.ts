...
@Controller('see360Payments')
export class See360PaymentsController {
  private razorpay: Razorpay;

  constructor(private readonly see360PaymentsService: See360PaymentsService) {
  ...
  async savePayment(@Body() paymentData) {
    return this.see360PaymentsService.create(paymentData);
  }

  @Get('/getPaymentList')
  async findAll(): Promise<See360Payment[]> {
    return this.see360PaymentsService.getPaymentList();
  }
  ...
  async getPayment(
    ...
    //   console.log('Saving payment data:', paymentData);
      ...
      await this.see360PaymentsService.create(paymentData);
