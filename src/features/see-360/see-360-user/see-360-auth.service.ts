...
@Injectable()
export class See360AuthService {
  constructor(
  ...
  async signIn(
    ...
    const user = await this.see360UserService.findByPhoneNumber(phoneNumber);
    ...
    await this.see360UserService.updateUserSessionToken(user.id, token);
